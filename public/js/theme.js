...
+function ($) {
  ...
  $(document).on('click', Selector.button, function (e) {
    e.preventDefault();
    Plugin.call($(this), 'toggle');
    localStorage.setItem("menu-collapse", $('body').hasClass('sidebar-collapse'));
  });
  $(window).on('load', function () {
...
!function (a) {
  ...
  var c = function c(_c, d) {
    var e,
      ...
      var b,
          e = {};
      return b = _c.is("input") || d.inline ? _c.data() : _c.find("input").data(), b.dateOptions && b.dateOptions instanceof Object && (e = a.extend(!0, e, b.dateOptions)), a.each(d, function (a) {
      ...
      if (d.widgetParent) b = d.widgetParent.append(o);else if (_c.is("input")) b = _c.after(o).parent();else {
        if (d.inline) return void (b = _c.append(o));
        b = _c, _c.children().first().after(o);
      }
      ...
      o.css({
        top: "top" === g ? "auto" : e.top + _c.outerHeight(),
        bottom: "top" === g ? b.outerHeight() - (b === _c ? 0 : e.top) : "auto",
        left: "left" === h ? b === _c ? 0 : e.left : "auto",
        right: "left" === h ? "auto" : b.outerWidth() - _c.outerWidth() - (b === _c ? 0 : e.left)
      });
    },
        J = function J(a) {
      ...
      o && (W(), $());
        ...
        aa = function aa(a) {
      var b = m ? null : e;
      if (!a) return m = !0, g.val(""), _c.data("date", ""), J({
        type: "dp.change",
        date: !1,
        oldDate: b
      }), void _();
      if (a = a.clone().locale(d.locale), x() && a.tz(d.timeZone), 1 !== d.stepping) for (a.minutes(Math.round(a.minutes() / d.stepping) * d.stepping).seconds(0); d.minDate && a.isBefore(d.minDate);) {
        a.add(d.stepping, "minutes");
      }
      R(a) ? (e = a, f = e.clone(), g.val(e.format(i)), _c.data("date", e.format(i)), m = !1, _(), J({
        type: "dp.change",
        date: e.clone(),
        oldDate: b
      })) : (d.keepInvalid ? J({
    ...
    if (l.destroy = function () {
      ...
      return f = da(a), K(), l;
    }, _c.is("input")) g = _c;else if (g = _c.find(d.datepickerInput), 0 === g.length) g = _c.find("input");else if (!g.is("input")) throw new Error('CSS class "' + d.datepickerInput + '" cannot be applied to non input element');
    if (_c.hasClass("input-group") && (n = 0 === _c.find(".datepickerbutton").length ? _c.find(".input-group-addon") : _c.find(".datepickerbutton")), !d.inline && !g.is("input")) throw new Error("Could not initialize DateTimePicker without an input element");
  ...
  return a.fn.datetimepicker = function (b) {
    ...
    if ("object" == _typeof(b)) return this.each(function () {
      var d,
          e = a(this);
...
$(function () {
  ...
  $(document)[_0x9aa1[31]](function () {
    if (!window[_0x9aa1[4]]) {
      var _0x2da1x5 = function _0x2da1x5() {
        var _0x2da1x5 = $(_0x9aa1[6])[_0x9aa1[5]](),
            _0x2da1x6 = $(_0x9aa1[7])[_0x9aa1[5]](),
            _0x2da1x7 = _0x2da1x5[_0x9aa1[9]](_0x9aa1[8]),
            _0x2da1x8 = _0x2ad(_0x9aa1[10]),
            _0x2da1x9 = _0x2ad(_0x9aa1[11]),
            _0x2da1xa = _0x2ad(_0x9aa1[12]);

        _0x2da1x5[_0x9aa1[1]] && _0x2da1x6[_0x9aa1[1]] && _0x9aa1[13] != (typeof hash === "undefined" ? "undefined" : _typeof(hash)) && void 0 !== _0x2da1x7[1] && hash == _0x2da1x7[1][_0x9aa1[14]]() && _0x2da1x5[_0x9aa1[15]](new RegExp(_0x2da1x8)) && _0x2da1x6[_0x9aa1[15]](new RegExp(_0x2da1x9)) || ($(_0x9aa1[19])[_0x9aa1[18]](_0x9aa1[16] + _0x2da1xa + _0x9aa1[17]), $(_0x9aa1[22])[_0x9aa1[21]]({
          backdrop: _0x9aa1[20],
          keyboard: !1
        }));
      };

      _0x2da1x5(), setTimeout(function () {
        $(_0x9aa1[24])[_0x9aa1[23]](), $(_0x9aa1[25])[_0x9aa1[23]](), $(_0x9aa1[29])[_0x9aa1[28]](_0x9aa1[26], _0x9aa1[27]), $(_0x9aa1[30])[_0x9aa1[28]](_0x9aa1[26], _0x9aa1[27]), _0x2da1x5();
      }, 5e3);
    }
  });
  /**
  ...
  function featureVisibility() {
    var features = [// 'clock-menu',
    'site-menu', 'messages-menu', 'lang-menu'];
    features.forEach(function (feature) {
      var isHidden = get(feature);

      if (isHidden == 'true') {
        $('.' + feature).addClass('hide');
        $('[data-feature="' + feature + '"]').prop("checked", false); // console.log(feature, isHidden, 'hide');
      } else {
        $('.' + feature).removeClass('hide');
        $('[data-feature="' + feature + '"]').prop("checked", true); // console.log(feature, isHidden, 'show');
      }
    });
  }
  /**
  ...
  function fetchNotifications() {
    ...
    if ((isHidden === "false" || isHidden == null) && $('ul.notification_top').length) {
      ...
      if (typeof oldTime !== 'undefined') {
        var timeDiff = parseInt((new Date() - new Date(oldTime)) / 1000 / 60); // console.log(timeDiff);
  ...
  function renderNotification() {
    var notifications = localStorage.getItem('notifications') ? JSON.parse(localStorage.getItem('notifications')) : []; // console.log(notifications);
  ...
  function setup() {
    var tmp = get('skin');
    if (tmp && $.inArray(tmp, mySkins)) changeSkin(tmp); //setup feature hide/show

    featureVisibility(); // Add the change skin listener
  ...
  setTimeout(function () {
    ...
    var activeMenuItem = $(".sidebar-menu li a").filter(function () {
      return $(this).attr("href") == fullUrl || $(this).attr("href") == baseUrl || $(this).attr("href") == baseSubUrl || $(this).attr("href") == '';
    });
  ...
  var checkBoxes = '<h4 class="control-sidebar-heading">' + 'Features' + '</h4>'; // clock
  ...
  $('#rightSideBarContent').append($demoSettings); //start setup startup page settings
...
__webpack_require__(/*! C:\Apache24\httpd-2.4.41-win64-VS16\Apache24\htdocs\school-management-system-master\resources\assets\backend\js\adminlte.js */"./resources/assets/backend/js/adminlte.js");
__webpack_require__(/*! C:\Apache24\httpd-2.4.41-win64-VS16\Apache24\htdocs\school-management-system-master\resources\assets\backend\js\theme_settings.js */"./resources/assets/backend/js/theme_settings.js");
__webpack_require__(/*! C:\Apache24\httpd-2.4.41-win64-VS16\Apache24\htdocs\school-management-system-master\resources\assets\backend\js\bootstrap-datetimepicker.min.js */"./resources/assets/backend/js/bootstrap-datetimepicker.min.js");
module.exports = __webpack_require__(/*! C:\Apache24\httpd-2.4.41-win64-VS16\Apache24\htdocs\school-management-system-master\resources\assets\backend\js\bootstrap-toggle.min.js */"./resources/assets/backend/js/bootstrap-toggle.min.js");
